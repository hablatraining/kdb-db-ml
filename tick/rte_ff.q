...
.u.init[];
path:`$":../models/weights_",label,".csv";                     / path depending topology
theta_final:@[;`weights](enlist"F";enlist",")0:path;        / load trained weights
...
upd:{[t;d]
  ...
  if[W<count get t;
    ...
    .rte.latency:.z.n-t0;insert[`lats;([]time:1#last d`time;lat:1#.rte.latency)];
